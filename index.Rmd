...
```{r out.width='170px', out.extra='style="float:right; padding:20px"', echo=FALSE}
...
* **Tatsumi S**, Yamaguchi K, Furuya N (2023) ForestScanner: a mobile application for measuring and mapping trees with LiDAR-equipped iPhone and iPad. [*Methods in Ecology and Evolution*](https://besjournals.onlinelibrary.wiley.com/doi/full/10.1111/2041-210X.13900){target="_blank"}. in press. [`r icons::fontawesome("file-pdf")`](pdf/Tatsumi_2023_MethodsEcolEvol.pdf){target="_blank"}
...
```{r out.width='120px', out.extra='style="float:right; padding:10px"', echo=FALSE}
knitr::include_graphics("image/book1.jpg")
knitr::include_graphics("image/book2.jpg")
```
