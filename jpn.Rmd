...
&emsp; `r icons::fontawesome("briefcase")` &thinsp; 京都大学 大学院農学研究科 森林科学専攻 [森林生態学研究室](https://www.rfecol.kais.kyoto-u.ac.jp/){target="_blank"}  
&emsp; `r icons::fontawesome("envelope")` &thinsp; community.ecologist at gmail dot com  

専門は群集生態学です。樹木群集の多種共存と生態系機能について、長期モニタリング・操作実験・理論的アプローチを組み合わせて研究しています。基礎科学としての群集生態学をベースに、「森林伐採や気候変動などの人為的要因が多種共存に与える影響」や「生物多様性と森林生産性の関係」といった、森林管理への応用を見据えたテーマに取り組んでいます。Research Mapは[こちら](https://researchmap.jp/shin1.ta23){target="_blank"}をご覧ください。
